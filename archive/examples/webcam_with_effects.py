...
utils = import_from_path('utils', '../research-effects-library/core/utils.py')
...
interlaced_vertical = import_from_path('interlaced_vertical', '../research-effects-library/effects/interlaced_vertical.py')
interlaced_horizontal = import_from_path('interlaced_horizontal', '../research-effects-library/effects/interlaced_horizontal.py')
gradient_tiles = import_from_path('gradient_tiles', '../research-effects-library/effects/gradient_tiles.py')
mondrian = import_from_path('mondrian', '../research-effects-library/effects/mondrian.py')
matrix = import_from_path('matrix', '../research-effects-library/effects/matrix.py')
statistical_vision = import_from_path('statistical_vision', '../research-effects-library/effects/statistical_vision.py')
bit_depth_strobe = import_from_path('bit_depth_strobe', '../research-effects-library/effects/bit_depth_strobe.py')
rgb_strobe = import_from_path('rgb_strobe', '../research-effects-library/effects/rgb_strobe.py')
rgb_even_odd_strobe = import_from_path('rgb_even_odd_strobe', '../research-effects-library/effects/rgb_even_odd_strobe.py')
rgb_matrix_strobe = import_from_path('rgb_matrix_strobe', '../research-effects-library/effects/rgb_matrix_strobe.py')
...
InterlacedVerticalEffect = interlaced_vertical.InterlacedVerticalEffect
InterlacedHorizontalEffect = interlaced_horizontal.InterlacedHorizontalEffect
GradientTilesEffect = gradient_tiles.GradientTilesEffect
MondrianEffect = mondrian.MondrianEffect
MatrixEffect = matrix.MatrixEffect
StatisticalVisionEffect = statistical_vision.StatisticalVisionEffect
BitDepthStrobeEffect = bit_depth_strobe.BitDepthStrobeEffect
RGBStrobeEffect = rgb_strobe.RGBStrobeEffect
RGBEvenOddStrobeEffect = rgb_even_odd_strobe.RGBEvenOddStrobeEffect
RGBMatrixStrobeEffect = rgb_matrix_strobe.RGBMatrixStrobeEffect
...
class VideoApp:
    def __init__(self, window, window_title):
        ...
        self.effects = {
            ...
            "Interlaced Vertical": InterlacedVerticalEffect(self.frame_shape),
            "Interlaced Horizontal": InterlacedHorizontalEffect(self.frame_shape),
            "Gradient Tiles": GradientTilesEffect(),
            "Mondrian": MondrianEffect(),
            "Matrix Digital Rain": MatrixEffect(),
            "Statistical Vision": StatisticalVisionEffect(),
            "Bit Depth Strobe": BitDepthStrobeEffect(),
            "RGB Strobe": RGBStrobeEffect(),
            "RGB Even-Odd Strobe": RGBEvenOddStrobeEffect(),
            "RGB Matrix Strobe": RGBMatrixStrobeEffect()
        }
